...
const APP_NAME = "AgentsHomeOffice";
...
function findProjectRoot() {
  ...
  const candidates = [
    path.join(home, "Documents", "GitHub", "AgentsHomeOffice"),
    path.join(home, "GitHub", "AgentsHomeOffice"),
    path.join(home, "Documents", "AgentsHomeOffice"),
    path.join(home, "AgentsHomeOffice"),
  ];
...
function createWindows(projectRoot) {
  ...
  miniWindow.setTitle("AgentsHomeOffice Mini");
