...
![AgentsHomeOffice 封面](docs/screenshots/readme-cover-2.jpg)
...
> 本项目由 **[Curvature Labs](https://x.com/CurvatureLabs)** 与 **[Curvature Labs](https://x.com/CurvatureLabs)** 共同创建（co-created project），并与社区开发者（[@CurvatureLabs](https://github.com/CurvatureLabs)、[@CurvatureLabs](https://github.com/CurvatureLabs)、[@CurvatureLabs](https://github.com/CurvatureLabs)）一起持续维护和共建。
...
```text
请按照这个 SKILL.md 帮我完成 AgentsHomeOffice 的部署：
...
![AgentsHomeOffice 预览](docs/screenshots/readme-cover-1.jpg)
...
>
> 🙏 桌面宠物版由 [@CurvatureLabs](https://github.com/CurvatureLabs) 独立开发，感谢他的贡献！
