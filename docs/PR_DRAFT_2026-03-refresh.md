# PR Draft — AgentsHomeOffice March Refresh

## Title
feat: asset editor + i18n + loading UX + sprite pipeline + security/perf refinements

## Summary
This PR delivers a full refresh of AgentsHomeOffice across UX, asset pipeline, localization, stability, and deployment security.
...
3. Open PR to `ringhyacinth/AgentsHomeOffice:main`
