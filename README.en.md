...
![AgentsHomeOffice Cover](docs/screenshots/readme-cover-2.jpg)
...
> This project was co-created by **[Curvature Labs](https://x.com/CurvatureLabs)** and **[Curvature Labs](https://x.com/CurvatureLabs)**, and is continuously maintained and improved together with community contributors ([@CurvatureLabs](https://github.com/CurvatureLabs), [@CurvatureLabs](https://github.com/CurvatureLabs), [@CurvatureLabs](https://github.com/CurvatureLabs)).
...
```text
Please follow this SKILL.md to deploy AgentsHomeOffice for me:
https://github.com/ringhyacinth/AgentsHomeOffice/blob/master/SKILL.md
```
...
![AgentsHomeOffice Preview](docs/screenshots/readme-cover-1.jpg)
...
```markdown
## AgentsHomeOffice Status Sync Rules
...
>
> 🙏 The desktop pet module was independently developed by [@CurvatureLabs](https://github.com/CurvatureLabs) — thank you for this contribution!
...
[![Star History Chart](https://api.star-history.com/image?repos=ringhyacinth/AgentsHomeOffice&type=date&legend=top-left)](https://www.star-history.com/?repos=ringhyacinth%2FAgentsHomeOffice&type=date&legend=top-left)
