#!/usr/bin/env python3
"""Curvature Labs - Backend State Service"""
...
DATA_DIR = os.environ.get("STAR_DATA_DIR") or os.path.join(ROOT_DIR, "data")
...
BG_HISTORY_DIR = os.path.join(DATA_DIR, "bg-history")
HOME_FAVORITES_DIR = os.path.join(DATA_DIR, "home-favorites")
...
def add_no_cache_headers(response):
    ...
    if path.startswith('/static/') and not path.endswith('.js') and not path.endswith('.html') and 200 <= response.status_code < 300:
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("Curvature Labs - Backend State Service")
    print("=" * 50)
