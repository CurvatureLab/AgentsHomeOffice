...
![AgentsHomeOffice カバー](docs/screenshots/readme-cover-2.jpg)
...
> 本プロジェクトは **[Curvature Labs](https://x.com/CurvatureLabs)** と **[Curvature Labs](https://x.com/CurvatureLabs)** の共同制作（co-created project）であり、コミュニティの開発者（[@CurvatureLabs](https://github.com/CurvatureLabs)、[@CurvatureLabs](https://github.com/CurvatureLabs)、[@CurvatureLabs](https://github.com/CurvatureLabs)）とともに継続的にメンテナンス・改善を行っています。
...
```text
この SKILL.md に従って AgentsHomeOffice をデプロイしてください：
...
![AgentsHomeOffice プレビュー](docs/screenshots/readme-cover-1.jpg)
...
>
> 🙏 デスクトップペット版は [@CurvatureLabs](https://github.com/CurvatureLabs) が独自に開発しました。貢献に感謝します！
