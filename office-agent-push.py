...
DEFAULT_STATE_CANDIDATES = [
    os.path.join(OPENCLAW_WORKSPACE_DIR, "AgentsHomeOffice", "state.json"),
    os.path.join(OPENCLAW_WORKSPACE_DIR, "state.json"),
    "/root/.openclaw/workspace/AgentsHomeOffice/state.json",  # 当前仓库（大小写精确）
    "/root/.openclaw/workspace/AgentsHomeOffice/state.json",  # 历史/兼容路径
